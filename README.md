...
1. Clone this repo using `git clone https://github.com/reactexcel/amavido_deck_dashboard.git`
2. Move to the appropriate directory: `cd amavido_deck_dashboard`.<br />
